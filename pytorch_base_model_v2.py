...
class PyTorchBaseModel(object):
    ...
    def fit(self, train_loader, test_loader, epoch, loss_function=None, optimizer=None, learning_rate=0.01, \
        ...
        try:
            ...
            _optimizer = _optimizer(trainable_params, lr=learning_rate)
            ...
            for ep in range(1, epoch+1):
                for batch_idx, (data, target) in enumerate(train_loader):
                    ...
                    if batch_idx % verbose == 0:
                        print('Epoch: {} [{}/{} ({:.0f}%)]\tAvg Train Loss per Batch: {:.6f}'.format(ep, batch_idx * len(data), \
                ...
                test_loss, test_log_loss = self.eval(self.model, test_loader)
