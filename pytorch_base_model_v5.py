...
class PyTorchBaseModel(object):
    ...
    def fit(self, train_loader, test_loader, epoch, loss_function=None, optimizer=None, learning_rate=0.001, \
            learning_rate_decay_rate=0.8, early_stopping_rounds=3, clip=-1, use_cuda=True, verbose=1, random_seed=7, \
            learning_rates=None, save_checkpoints=True, **kwargs):
        '''
        learning_rate_decay_rate will override learning_rates.
        :param train_loader:
        :param epoch:
        :param use_cuda:
        ...
        try:
            ...
            for ep in range(1, epoch+1):
                ...
                print("Running time for this epoch: {:.2f} minutes.".format(_ep_time_cost))
                logging.info("Running time for this epoch: {:.2f} minutes.".format(_ep_time_cost))
